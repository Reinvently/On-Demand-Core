...
use reinvently\ondemand\core\modules\category\models\CategorySearch;
...
class AdminCategoryController extends AdminController
{
    ...
    public function actionIndex()
    {
        ...
        return $this->render('@app/core/modules/category/views/category/index', [
    ...
    {
        return $this->render('@app/core/modules/category/views/category/view', [
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@app/core/modules/category/views/category/update', [
                'model' => $model,
            ]);
        }
    }
