...
class AdminUserController extends AdminController
{
    ...
    public function actionIndex()
    {
        ...
        return $this->render('@app/core/modules/user/views/admin/user/index', [
    ...
    {
        return $this->render('@app/core/modules/user/views/admin/user/view', [
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@app/core/modules/user/views/admin/user/create', [
                'model' => $model,
            ]);
        }
    }
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('@app/core/modules/user/views/admin/user/update', [
                'model' => $model,
            ]);
        }
    }
