...
/** @var \reinvently\ondemand\core\components\loggers\models\ConsoleLogSearch $searchModel */
...
<?= \yii\grid\GridView::widget([
		...
		'columns' => [
			[
				'attribute' => 'id',
				'value' => 'id',
				'filter' => '><input type="text" name="ConsoleLogSearch[moreId]" value="' . $searchModel->moreId . '" class="form-control"><br><<input type="text" name="ConsoleLogSearch[lessId]" value="' . $searchModel->lessId . '" class="form-control">'
			],
            [
                'attribute' => 'route',
                'filter' =>
