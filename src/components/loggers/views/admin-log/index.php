...
/** @var \reinvently\ondemand\core\components\loggers\models\AdminLogSearch $searchModel */
...
<?= \yii\grid\GridView::widget([
		...
		'columns' => [
			[
				'attribute' => 'id',
				'value' => 'id',
				'filter' => '><input type="text" name="AdminLogSearch[moreId]" value="' . $searchModel->moreId . '" class="form-control"><br><<input type="text" name="AdminLogSearch[lessId]" value="' . $searchModel->lessId . '" class="form-control">'
			],
			'userId',
            [
                'attribute' => 'route',
